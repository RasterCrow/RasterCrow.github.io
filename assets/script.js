var text = {
	"en": {
		...
		"portfolio": {
			...
			"slide4": {
				...
				"desc": `Webapp I made to keep track of the Italian BoxOffice. It's for private use only. <br> A demo version is available <a href="https://boxoffice.rastercrow.me" rel="noopener" target="_blank">here</a> ( It's only available in Italian ). <br> Made witch React, Express and Mongo, you can find out more about it on <a href="https://github.com/RasterCrow/Boxoffice_Italia" rel="noopener" target="_blank"><img class="link_icon" src="assets/data/github-icon.png" alt="github icon"> Github</a>`
			},
			"slide5": {
	...
	"it": {
		...
		"portfolio": {
			...
			"slide4": {
				"title": "BoxOffice Italia Webapp",
				"desc": `Webapp per controllare lo stato del botteghino cinematografico italiano. Disponibile solo per uso privato. <br> Una versione demo e' disponibile <a href="https://boxoffice.rastercrow.me" rel="noopener" target="_blank">qui</a>. <br> Sviluppato in React, Express e Mongo, altre info sulla repository di <a href="https://github.com/RasterCrow/Boxoffice_Italia" rel="noopener" target="_blank"><img class="link_icon" src="assets/data/github-icon.png" alt="github icon"> Github</a>`
			},
			"slide5": {
	...
	function addStickyNavbar() {
		...
		if (!isMobile) {
			if (window.pageYOffset >= sticky) {
				//adds also the shadow
				navbar.classList.add("navbarShadow")
				//adds stickiness
				navbar.classList.add("sticky")
				navbar.classList.add("trasparent-background")
				content.classList.add("content")
			} else {
				navbar.classList.remove("navbarShadow")
